...
const Tiebreakers = {
	...
	versus: {
		...
		diff: (a, b) =>
			a.results
				.filter(m => m.opponent === b.id)
				.reduce((x, y) => (x += y.result === "w" ? -1 : y.result === "l" ? 1 : 0), 0)
	},
	/**
	...
	magictcg: {
		...
		diff: (a, b, n) =>
			n === 1
				? b.tiebreakers.oppMatchWinPctM - a.tiebreakers.oppMatchWinPctM
				: n === 2
				? b.tiebreakers.gameWinPct - a.tiebreakers.gameWinPct
				: b.tiebreakers.oppGameWinPct - a.tiebreakers.oppGameWinPct
	},
	/**
	...
	pokemontcg: {
		...
		diff: (a, b, n) =>
			n === 1
				? b.tiebreakers.oppMatchWinPctP - a.tiebreakers.oppMatchWinPctP
				: b.tiebreakers.oppOppMatchWinPct - a.tiebreakers.oppOppMatchWinPct
	}
};
